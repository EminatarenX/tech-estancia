...
<section class="p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="category" id="category"
                        class="p-3 w-full text-neutral-600 mt-1 outline-none border-b-2">
                ...
                <div>
                    ...
                    <input type="number" name="stock" id="stock" class="p-3 w-full mt-1 outline-none border-b-2"
                        required>
                </div>
                <div>
                    <label for="price" class="block text-gray-500">Precio</label>
                    <input type="text" name="price" id="price" class="p-3 w-full mt-1 outline-none border-b-2"
                        required>
                </div>
            </div>
            <div class="mt-5">
    ...
    <div class="mt-10">
        <h2 class="text-2xl font-semibold text-cyan-600">Productos</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mt-5">
            @foreach ($productos as $producto)
            <div class="border border-gray-200 p-4 rounded-lg shadow-md">
                <h3 class="text-lg font-semibold text-cyan-600">{{ $producto->nombre }}</h3>
